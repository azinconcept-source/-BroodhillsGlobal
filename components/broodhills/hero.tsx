...
export function Hero({ onEnter, onExplore }: { onEnter: () => void; onExplore: () => void }) {
    return (
        <section style={{ padding: "120px 6% 80px", background: WHITE }}>
            <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
                {/* Left */}
                <div>
                    <h1 style={{ fontFamily: "Fraunces, serif", fontWeight: 900, fontSize: "clamp(36px, 4.5vw, 56px)", lineHeight: 1.1, color: BLACK, margin: "0 0 20px" }}>
                    ...
                    <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 48 }}>
                        <button onClick={onExplore} style={{
                            ...
                            padding: "13px 28px", fontFamily: "DM Sans, sans-serif", fontSize: 14, fontWeight: 600, cursor: "pointer", transition: "all 0.2s",
                        }}
                        ...
                        <div style={{ display: "flex", gap: 28, alignItems: "center", flexWrap: "wrap" }}>
                            {[
                                ...
                                <div key={i} style={{ opacity: 0.7, transition: "opacity 0.2s" }}
                                    ...
                                    <img src={logo.src} alt={logo.alt} style={{ height: 32, width: "auto", objectFit: "contain", display: "block" }} />
                                </div>
                            ))}
                        </div>
                    </div>
