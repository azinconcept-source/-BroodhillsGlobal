...
export function CTABanner({ onEnter }: { onEnter: () => void }) {
    return (
        <section style={{ padding: "80px 6%", background: BLACK, position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative" }}>
                ...
                <h2 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(30px, 4vw, 52px)", fontWeight: 900, color: WHITE, margin: "0 0 8px", lineHeight: 1.2 }}>Got a Project?</h2>
                <h2 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(30px, 4vw, 52px)", fontWeight: 900, margin: "0 0 24px", lineHeight: 1.2 }}>
